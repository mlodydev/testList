...
import ListItem from '../../Basic_components/ListItem';
import ListButtons from '../../Basic_components/ListButtons';
import SearchBar from '../../Basic_components/SearchBar';

const EmptyListComponent = () => (
  <View style={styles.emptyList}>
    <Text>Welcome! Wait for content.</Text>
  </View>
);
...
const ListCompHooks = props => {
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.buttons}>{bottomMenu}</View>
    </View>
  );
};
